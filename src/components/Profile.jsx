...
const Profile = () => {
  ...
  const handleUpdateData = (e) => {
    e.preventDefault();
    axios.patch(`${baseApiUrl}/users/${userId}/`,
      {
        info: {
        name: newName,
        surname: newSurname,
      ...
      .then(response => dispatch({type: ACTION_TYPES.EDIT_USER, payload: response.data}))
    ...
    <div className='flex-container row'>
      ...
      {!inEdit
        ...
        <div className="user-profile-info">
          <span>{userName}</span>
          {/*<span>Name: {user.info.name}</span>*/}
          {/*<span>Surname: {user.info.surname}</span>*/}
          {/*<span>Location: {user.info.location}</span>*/}
          {/*<span>Additional info: {user.info.additional}</span>*/}
          <button onClick={() => setInEdit(true)}>Edit info</button>
        </div>
        :
        <div className="user-profile-input">
          <form onSubmit={handleUpdateData} className="profile-input">
            ...
            />
            <label htmlFor="user-description">Additional info</label>
            <textarea
